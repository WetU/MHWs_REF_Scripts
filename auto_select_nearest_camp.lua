...
local Int32_type_def = get_AreaNum_method:get_return_type();
...
local StartPointList_type_def = sdk.find_type_definition("app.GUI050001_StartPointList");
...
local function dataProcess(GUI050001_ptr, targetCampIdx, list_size)
    ...
    hook_datas.inputCtrl = sdk.get_native_field(sdk.get_native_field(GUI050001_ptr, GUI050001_type_def, "_StartPointList"), StartPointList_type_def, "_InputCtrl");
...
sdk.hook(GUI050001_type_def:get_method("initStartPoint"), function(args)
    ...
    if get_IsSameStageDeclaration_method:call(QuestOrderParam) == false then
        ...
        if list_size > 1 then
            local QuestViewData = sdk.get_native_field(QuestOrderParam, QuestOrderParam_type_def, "QuestViewData");
            local Stage = get_Stage_method:call(QuestViewData);
            local targetEmStartArea = sdk.get_native_field(get_TargetEmStartArea_method:call(QuestViewData):get_element(0), Int32_type_def, "m_value");
